...
//     // address tokenProtAddress = 0xC15099c7c260aF4a77f1541Db3Dd9BfBCAbaF81D;
//     function lockTokens(uint256 amount) public payable{
//         // ERC20(tokenProtAddress).transferFrom(msg.sender, address(this), amount);
//         prot.transfer(address(this), amount);
//         // ERC20(tokenProtAddress).transfer(tokenProtAddress, amount);
//         // prot.transferFrom(msg.sender, address(this), amount);
//     }
// }
...
contract StakeAPL is Pausable, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function stakeToken(uint256 stakeAmount) external payable whenNotPaused {
        ...
        // aplToken.transfer(address(this), stakeAmount);
        totalStakers++;
        addressStaked[_msgSender()] = true;
